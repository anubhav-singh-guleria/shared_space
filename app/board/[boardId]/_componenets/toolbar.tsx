            ...
            <div className="bg-white rounded-md p-1.5 flex gap-y-1 flex-col items-center shadow-md">
                <ToolButton
                    ...
                    isActive={
                        ...
                        canvasState.mode === CanvasMode.Pressing || canvasState.mode === CanvasMode.Translating 
                        || canvasState.mode === CanvasMode.Resizing || canvasState.mode === CanvasMode.SelectionNet
                    }
                />
                <ToolButton
                    label="Text"
